...
QUERY_LIST = [
    "Donald Trump",
    "Joe Biden",
]  # Add default names of politicians to look for
...
class NYTCrawler(Crawler):
    ...
    def make_request(
        ...
        url = self.create_url(
            tags, news_desk, section, filters, begin_date, end_date, page
        )
    ...
    def crawl(
        ...
        resp = self.make_request(
            tags, news_desk, section, filters, begin_date, end_date
        )
